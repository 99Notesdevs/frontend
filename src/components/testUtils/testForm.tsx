        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("timeTaken", parseInt(e.target.value))
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("questionsSingle", parseInt(e.target.value))
                }
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("correctAttempted", parseInt(e.target.value))
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("wrongAttempted", parseInt(e.target.value))
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("notAttempted", parseInt(e.target.value))
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange("partialAttempted", parseInt(e.target.value))
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400"
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange("wrongAttempted", parseInt(e.target.value) || 0)
            }
            className="w-full p-2 border rounded"
            required
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange("notAttempted", parseInt(e.target.value) || 0)
            }
            className="w-full p-2 border rounded"
            required
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              handleInputChange("timeTaken", parseInt(e.target.value) || 0)
            }
            className="w-full p-2 border rounded"
            required
          />
