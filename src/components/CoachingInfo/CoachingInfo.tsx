      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="space-y-8 mb-12">
          <div className="text-center mb-0">
            ...
            <h2 className="text-3xl font-semibold text-[var(--surface-dark)] dark:text-white mt-2 mb-4">
              {title}
            </h2>
          </div>
          <div className="w-24 h-1 bg-[var(--primary)] mx-auto mb-6"></div>
          <p className="text-xl text-[var(--text-strong)] dark:text-gray-300 text-center max-w-3xl mx-auto">
            {description}
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="lg:col-span-1">
            {faqs && faqs.length > 0 ? (
              ...
              <p className="text-center text-[var(--text-tertiary)] dark:text-gray-400">
                No FAQs available
              </p>
            )}
          </div>
