...
const CurrentAffairs: React.FC<CurrentAffairsProps> = ({
  ...
  const fetchCurrentAffairs = async () => {
    try {
      setError(null);
      const response = (await api.get(`/currentAffair/type/daily`)) as {
        success: boolean;
      ...
      setError(
        "Failed to load current affairs. Please check your internet connection and try again."
      );
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="py-16 bg-[var(--bg-main)] dark:bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-[var(--surface-darker)] dark:text-white mb-4">
              Current Affairs
            </h2>
          ...
          <div className="text-center p-8">
            ...
            <p className="text-[var(--text-tertiary)] dark:text-gray-300 mb-4">
              {error}
            </p>
            <button
    ...
    <section className="py-16 bg-[var(--bg-main)] dark:bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-semibold text-[var(--surface-darker)] dark:text-white mb-4 font-opensans">
            {title}
          </h2>
