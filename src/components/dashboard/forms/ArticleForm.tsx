...
export const ArticleForm: React.FC<ArticleFormProps> = ({ initialData, onSubmit }) => {
        ...
        if (selectedDraft) {
          ...
          if (!formData.FAQ || formData.FAQ === "") {
            ...
            try {
              ...
              if (!faqData || !faqData.general || !Array.isArray(faqData.general)) {
                formData.FAQ = JSON.stringify({ general: [] })
              }
            } catch (e) {
    ...
    <div className="relative">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmitForm)} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <TiptapEditor content={field.value} onChange={handleEditorChange} />
                </FormControl>
              </FormItem>
            )}
          />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Select value={field.value || "index,follow"} onValueChange={field.onChange}>
                      <SelectTrigger>
              ...
              <div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <FAQEditor ref={faqEditorRef} value={field.value} onChange={field.onChange} />
                      </FormControl>
                      <FormDescription>Add frequently asked questions in a structured format.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
          ...
          <Button disabled={isUploading} type="submit" className="mt-6 bg-slate-700 hover:bg-slate-800 text-white">
