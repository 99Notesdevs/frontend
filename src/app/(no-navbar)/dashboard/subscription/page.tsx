      ...
      <div>
        ...
        <div className="mb-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <input
              className="border-0 border-b-2 border-[var(--admin-scroll-thumb)] bg-transparent focus:outline-none focus:ring-0 focus:border-[var(--admin-primary)] transition-colors placeholder-[var(--admin-scroll-thumb-hover)] text-[var(--admin-bg-secondary)]"
              placeholder="Title"
              value={newOrderTitle}
            ...
            />
            <select
              className="border-0 border-b-2 border-[var(--admin-scroll-thumb)] bg-transparent focus:outline-none focus:ring-0 focus:border-[var(--admin-primary)] transition-colors text-[var(--admin-bg-secondary)]"
          ...
          <button
            className="mt-4 w-full sm:w-auto px-6 py-2 rounded-lg bg-[var(--primary)] hover:bg-[var(--secondary)] text-white font-semibold shadow transition"
            onClick={createOrder}
          >
            Create Order
          </button>
          ...
          <table className="min-w-full border-collapse text-sm">
            <thead>
              <tr className="bg-[var(--admin-bg-light)]">
                <th className="border-b px-6 py-3 text-[var(--admin-bg-primary)] font-semibold uppercase text-left">
                  Title
                </th>
                <th className="border-b px-6 py-3 text-[var(--admin-bg-primary)] font-semibold uppercase text-left">
                  Description
            ...
            <tbody>
              {orders.map((order) => (
                <tr
                  key={order.id}
                  className="even:bg-[var(--admin-bg-lightest)] hover:bg-[var(--admin-bg-light)] transition"
                >
                  <td className="px-6 py-3 text-[var(--admin-bg-dark)] font-medium align-middle">
                    {order.name}
                  </td>
                  <td className="px-6 py-3 text-[var(--admin-bg-primary)] align-middle">
                    {order.description}
                  </td>
                  <td className="px-6 py-3 text-[var(--admin-bg-primary)] align-middle">
                    ₹{order.price}
                  ...
                  <td className="px-6 py-3 align-middle">
                    <button className="px-3 py-1 rounded bg-[var(--primary)] hover:bg-[var(--secondary)] text-white mr-2 text-xs font-semibold transition">
                      Edit
                    </button>
