        ...
        <div className="container mx-auto p-6">
            ...
            {editingSection === "hero" ? (
              <div className="mt-4">
                <label className="block mb-4">
                  <span className="text-[var(--admin-bg-primary)] font-medium">Hero Image URL:</span>
                  <input
                    type="text"
                ...
                <label className="block mb-4">
                  <span className="text-[var(--admin-bg-primary)] font-medium">Hero Text:</span>
                  <textarea
            ...
            {editingSection === "whatWeDo" ? (
              <div className="mt-4 space-y-4">
                <label className="block">
                  <span className="text-[var(--admin-bg-primary)] font-medium">Title:</span>
                  <input
                    type="text"
                ...
                <label className="block">
                  <span className="text-[var(--admin-bg-primary)] font-medium">Description:</span>
                  <textarea
                ...
                <label className="block">
                  <span className="text-[var(--admin-bg-primary)] font-medium">Image URL:</span>
                  <input
                    type="text"
                ...
                <div>
                  <span className="text-[var(--admin-bg-primary)] font-medium block mb-2">Items:</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-lg font-semibold text-[var(--admin-bg-dark)] mb-3">{content?.whatWeDo.title}</h3>
                  <p className="text-[var(--admin-secondary)] mb-4">{content?.whatWeDo.description}</p>
                  <ul className="space-y-2">
                    {content?.whatWeDo.items.map((item, index) => (
                      <li key={index} className="flex items-start">
                        <span className="text-[var(--admin-bg-dark)] mr-2">•</span>
                        <span className="text-[var(--admin-secondary)]">{item}</span>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <section id="mission-section" className="mb-10 bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
            ...
            {editingSection === "mission" ? (
              ...
              <div className="bg-[var(--admin-bg-lightest)] p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-[var(--admin-bg-dark)] mb-3">{content?.mission.title}</h3>
                <p className="text-[var(--admin-secondary)]">{content?.mission.description}</p>
              </div>
            )}
          </section>
          ...
          <section id="founder-section" className="mb-10 bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
            ...
            {editingSection === "founder" ? (
              <div className="mt-4 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <label className="block">
                      <span className="text-[var(--admin-bg-primary)] font-medium">Name:</span>
                      <input
                        type="text"
                    ...
                    <label className="block">
                      <span className="text-[var(--admin-bg-primary)] font-medium">Quote:</span>
                      <textarea
                  ...
                  <div>
                    <span className="text-[var(--admin-bg-primary)] font-medium block mb-2">Description:</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-[var(--admin-bg-dark)]">{content?.founder.name}</h3>
                  <p className="text-[var(--admin-secondary)] mb-4">{content?.founder.title}</p>
                  ...
                  <div className="space-y-2">
                    {content?.founder.description.map((desc, index) => (
                      <p key={index} className="text-[var(--admin-secondary)]">{desc}</p>
                    ))}
                  </div>
                </div>
              </div>
          ...
          <section id="cofounder-section" className="mb-10 bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
            ...
            {editingSection === "cofounder" ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-xl font-semibold text-[var(--admin-bg-dark)]">{content?.cofounder.name}</h3>
                  <p className="text-[var(--admin-secondary)] mb-4">{content?.cofounder.title}</p>
                  <blockquote className="italic text-[var(--admin-secondary)] border-l-4 border-[var(--admin-bg-dark)] pl-4 mb-4">
          ...
          <section id="veterans-section" className="mb-10 bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
            ...
            {editingSection === "veterans" ? (
              <div className="mt-4 space-y-4">
                ...
                <div>
                  <span className="text-[var(--admin-bg-primary)] font-medium block mb-2">Images:</span>
                  {tempContent.veterans?.images.map((image, index) => (
                    <div key={index} className="mb-4 p-4 border border-[var(--admin-scroll-thumb)] rounded-md bg-[var(--admin-bg-lightest)]">
                      <label className="block mb-2">
                        <span className="text-[var(--admin-bg-primary)] text-sm">Image URL:</span>
                        <input
                          type="text"
                          value={image.src}
                          onChange={(e) =>
                      ...
                      <label className="block mb-2">
                        <span className="text-[var(--admin-bg-primary)] text-sm">Alt Text:</span>
                        <input
                          type="text"
                          value={image.alt}
                          onChange={(e) =>
                      ...
                      <label className="block mb-2">
                        <span className="text-[var(--admin-bg-primary)] text-sm">Info:</span>
                        <textarea
                          value={image.info}
                          onChange={(e) =>
                            handleArrayInputChange(
              ...
              <div>
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-[var(--admin-bg-dark)] mb-2">{content?.veterans.title}</h3>
                  <p className="text-[var(--admin-secondary)]">{content?.veterans.description}</p>
                </div>
          ...
          <section id="core-members-section" className="mb-10 bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-300">
            ...
            {editingSection === "coreMembers" ? (
              ...
              <div>
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-[var(--admin-bg-dark)] mb-2">{content?.coreMembers.title}</h3>
                  <p className="text-[var(--admin-secondary)]">{content?.coreMembers.description}</p>
                </div>
                <div className="bg-[var(--admin-bg-lightest)] p-4 rounded-lg">
