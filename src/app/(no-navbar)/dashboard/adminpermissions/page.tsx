    ...
    const toggleGlobalRestrictions = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                showSuccessToast(newState ? 'Content locked successfully' : 'Content unlocked successfully');
            } else {
        ...
        <div className="p-6 max-w-5xl mx-auto space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <div className="flex items-center justify-between mb-4">
                    <div>
                        <h2 className="text-xl font-semibold text-gray-800">Content Restrictions</h2>
                        <p className="text-gray-600">Control global access to the content</p>
                    </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <h2 className="text-xl font-semibold text-gray-800 mb-2">Global Header Scripts</h2>
                <p className="text-gray-600 mb-4">Add scripts that will be injected into the &lt;head&gt; section of every page</p>
                
                <div className="mb-4">
                    <label htmlFor="header-scripts" className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div className="flex items-center">
                    ...
                    <span className="ml-3 text-sm text-gray-500">
                        {headerScript.split('\n').filter(Boolean).length} script(s) configured
                    </span>
                </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <h2 className="text-xl font-semibold text-gray-800 mb-2">Global Footer Scripts</h2>
                <p className="text-gray-600 mb-4">Add scripts that will be injected just before the closing &lt;/body&gt; tag</p>
                
                <div className="mb-4">
                    <label htmlFor="footer-scripts" className="block text-sm font-medium text-gray-700 mb-2">
                        Scripts (one per line)
                    </label>
                    <textarea
                        id="footer-scripts"
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <h2 className="text-xl font-semibold text-gray-800 mb-2">Practice Questions</h2>
                <p className="text-gray-600 mb-4">Set the maximum number of practice questions users can attempt</p>
                
                <div className="max-w-md">
                    <label htmlFor="practice-questions" className="block text-sm font-medium text-gray-700 mb-2">
