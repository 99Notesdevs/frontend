...
function About() {
  ...
  return (
    <>
      ...
      <main className="w-full min-h-screen overflow-hidden bg-gradient-to-b from-white to-blue-50/30">
        {/* Hero Section with asymmetric design */}
        <div className="absolute top-0 right-0 w-1/3 h-96 bg-blue-50/40 rounded-bl-[120px] transform rotate-6 z-0"></div>
        <div className="absolute bottom-0 left-0 w-1/4 h-80 bg-indigo-50/40 rounded-tr-[100px] transform -rotate-6 z-0"></div>
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative mt-10">
          <div className="absolute -top-10 left-1/4 w-20 h-20 bg-blue-100/50 rounded-full animate-pulse"></div>
          <div className="absolute bottom-10 right-20 w-32 h-32 bg-indigo-50/50 rounded-full animate-pulse delay-300"></div>
          <div className="absolute top-40 right-40 w-16 h-16 bg-purple-100/40 rounded-full animate-pulse delay-700"></div>
          
          {/* Asymmetric layout with offset elements */}
          <div className="flex flex-col md:flex-row items-center gap-16 relative">
            <div className="md:w-1/2 relative group transform transition-all duration-500 hover:scale-105">
              <div className="relative h-[450px] overflow-hidden rounded-tl-3xl rounded-br-3xl rounded-tr-xl rounded-bl-xl shadow-xl">
                {/* Decorative corners */}
            ...
            <div className="md:w-1/2">
              <div className="space-y-8">
                <h1 className="font-playfair text-6xl font-bold text-gray-900 leading-tight relative">
                  About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 relative">99Notes
                ...
                <p className="text-xl leading-relaxed text-gray-700 font-poppins pl-4 border-l-4 border-indigo-200">{content.heroText}</p>
                {/* Decorative element */}
        ...
        {/* What We Do Section with enhanced design */}
        <section className="py-24 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-white to-blue-50/30 -z-10"></div>
          <div className="absolute top-1/3 right-0 w-72 h-72 bg-indigo-100/30 rounded-full blur-3xl -z-10"></div>
          <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-blue-100/30 rounded-full blur-3xl -z-10"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-[400px] overflow-hidden rounded-tr-3xl rounded-bl-3xl rounded-tl-xl rounded-br-xl shadow-xl group">
                {/* Decorative corners */}
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 p-12 md:p-16 flex flex-col justify-center relative">
                  ...
                  <h2 className="font-playfair text-5xl font-bold text-gray-900 mb-8 relative">
                    Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 relative">
                      Mission
                      <svg className="absolute -bottom-2 left-0 w-full" height="6" viewBox="0 0 200 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 3C50 0.5 150 0.5 200 3" stroke="url(#paint0_linear)" strokeWidth="5" strokeLinecap="round"/>
                        <defs>
                  ...
                  <div className="text-white max-w-md relative z-10">
                    ...
                    <ul className="space-y-6">
                      <li className="flex items-start group">
                        ...
                        <p className="text-lg group-hover:translate-x-1 transition-transform duration-300">Expert team with years of experience</p>
                      </li>
                      <li className="flex items-start group">
                        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white/20 flex items-center justify-center mr-4 group-hover:bg-white/30 transition-all duration-300">
                          <svg className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p className="text-lg group-hover:translate-x-1 transition-transform duration-300">Innovative solutions for modern challenges</p>
                      </li>
                      <li className="flex items-start group">
                        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white/20 flex items-center justify-center mr-4 group-hover:bg-white/30 transition-all duration-300">
                          <svg className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <p className="text-lg group-hover:translate-x-1 transition-transform duration-300">Commitment to excellence and quality</p>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="md:w-1/2 order-2 md:order-1">
                <div className="bg-white rounded-lg shadow-lg p-10 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 relative">
                  ...
                  <blockquote className="text-lg italic text-gray-700 border-l-4 border-blue-500 pl-6 py-2 mb-8 relative">
                    <div className="absolute -top-2 -left-2 text-5xl text-blue-200/50 font-serif">"</div>
                    <div className="relative z-10">{content.founder.quote}</div>
                    <div className="absolute -bottom-4 -right-2 text-5xl text-blue-200/50 font-serif">"</div>
                  </blockquote>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl my-16 relative overflow-hidden">
          ...
          <div className="text-center mb-16 relative">
            <span className="absolute -top-10 left-1/2 transform -translate-x-1/2 text-8xl text-blue-100/40 font-playfair font-bold">Veterans</span>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl my-16 relative overflow-hidden">
          ...
          <div className="text-center mb-16 relative">
            <span className="absolute -top-10 left-1/2 transform -translate-x-1/2 text-8xl text-blue-100/40 font-playfair font-bold">Team</span>
            <h2 className="font-playfair text-5xl font-bold text-gray-900 relative">
              Our{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">
                Core Members
