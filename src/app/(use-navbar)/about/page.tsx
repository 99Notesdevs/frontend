...
const About = async () => {
  ...
  return (
    <>
      ...
      <main className="w-full min-h-screen overflow-x-hidden bg-gradient-to-b from-white to-amber-50/30">
        {/* Hero Section with asymmetric design */}
        <div className="absolute top-0 right-0 w-1/3 h-96 bg-amber-50/40 rounded-bl-[120px] transform rotate-6 z-0 max-w-full"></div>
        <div className="absolute bottom-0 left-0 w-1/4 h-80 bg-amber-50/40 rounded-tr-[100px] transform -rotate-6 z-0 max-w-full"></div>
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 relative mt-6 md:mt-10">
          <div className="absolute -top-10 left-1/4 w-20 h-20 bg-amber-100/50 rounded-full animate-pulse hidden md:block"></div>
          <div className="absolute bottom-10 right-20 w-32 h-32 bg-amber-50/50 rounded-full animate-pulse delay-300 hidden md:block"></div>
          <div className="absolute top-40 right-40 w-16 h-16 bg-amber-100/40 rounded-full animate-pulse delay-700 hidden md:block"></div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 relative">
            <div className="w-full md:w-1/2 relative group transform transition-all duration-500 hover:scale-105">
              <div className="relative h-[300px] sm:h-[350px] md:h-[450px] overflow-hidden rounded-tl-3xl rounded-br-3xl rounded-tr-xl rounded-bl-xl shadow-xl">
                {/* Decorative corners */}
                <div className="absolute -top-4 -left-4 w-16 h-16 border-t-4 border-l-4 border-amber-400/60 rounded-tl-xl z-20"></div>
                <div className="absolute -bottom-4 -right-4 w-16 h-16 border-b-4 border-r-4 border-amber-400/60 rounded-br-xl z-20"></div>
            ...
            <div className="w-full md:w-1/2 relative z-10">
              <div className="space-y-8">
                ...
                <p className="text-xl leading-relaxed text-gray-700 pl-4 border-l-4 border-amber-200">
                  {content.heroText}
                </p>
                {/* Decorative element */}
        ...
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative">
          <div className="absolute top-0 right-0 w-64 h-64 bg-amber-200/20 rounded-full blur-2xl"></div>
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-amber-200/20 rounded-full blur-2xl"></div>

          <div className="text-center mb-12 md:mb-16 relative">
            <h2 className="text-6xl font-bold text-gray-900 relative z-10">{content.whatWeDo.title}</h2>
            <div className="w-24 h-1.5 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full mx-auto mt-4"></div>
            <p className="text-gray-700 mt-6 max-w-2xl mx-auto text-lg ">{content.whatWeDo.description}</p>
          </div>
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
              <p className="text-xl leading-relaxed text-gray-700 ">{content.whatWeDo.description}</p>
              <ul className="space-y-6">
                {content.whatWeDo.items.map((item, index) => (
                  <li key={index} className="flex items-start space-x-4 group">
                    <span className="flex-shrink-0 w-8 h-8 rounded-md bg-gradient-to-r from-amber-500 to-amber-600 flex items-center justify-center text-white font-bold transform group-hover:scale-110 transition-transform duration-300 rotate-3">
                      {index + 1}
                    </span>
                    <span className="text-xl text-gray-700 group-hover:text-amber-600 transition-colors duration-300">
                      {item}
                    </span>
                  </li>
                ))}
            ...
            <div className="w-full lg:w-1/2 order-1 lg:order-2 relative group transform transition-all duration-500 hover:scale-105">
              <div className="relative h-[300px] sm:h-[350px] md:h-[450px] overflow-hidden rounded-tr-3xl rounded-bl-3xl rounded-tl-xl rounded-br-xl shadow-xl">
                {/* Decorative corners */}
                <div className="absolute -top-4 -right-4 w-16 h-16 border-t-4 border-r-4 border-amber-400/60 rounded-tr-xl z-20"></div>
                <div className="absolute -bottom-4 -left-4 w-16 h-16 border-b-4 border-l-4 border-amber-400/60 rounded-bl-xl z-20"></div>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-1/3 h-full bg-amber-100/20 rounded-l-full -z-10 transform skew-y-6"></div>
          <div className="absolute bottom-0 left-0 w-1/4 h-1/2 bg-amber-100/20 rounded-tr-full -z-10"></div>

          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="absolute top-10 left-10 w-20 h-20 border-t border-l border-amber-200 opacity-70"></div>
            <div className="absolute bottom-10 right-10 w-20 h-20 border-b border-r border-amber-200 opacity-70"></div>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-xl shadow-2xl overflow-hidden border border-gray-100 transform hover:scale-[1.01] transition-all duration-700">
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 p-12 md:p-16 flex flex-col justify-center relative">
                  <div className="absolute top-0 left-0 w-24 h-24 border-t-4 border-l-4 border-amber-200 -mt-4 -ml-4"></div>
                  ...
                  <p className="text-gray-700 text-lg leading-relaxed mb-6 first-letter:text-4xl first-letter:font-bold first-letter:text-amber-600 first-letter:mr-1 first-letter:float-left">
                  ...
                  <div className="absolute bottom-0 right-0 w-24 h-24 border-b-4 border-r-4 border-amber-200 -mb-4 -mr-4"></div>
                </div>
                <div className="md:w-1/2 bg-gradient-to-br from-amber-400 via-amber-500 to-amber-600 p-12 md:p-16 flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-amber-400/10 rounded-full transform -translate-x-1/2 -translate-y-1/2 blur-sm animate-pulse"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-5xl font-bold text-gray-900 relative inline-block">
                ...
                <div className="absolute -bottom-4 left-0 w-full h-1 bg-gradient-to-r from-amber-200 to-transparent"></div>
              </h2>
            </div>
            <div className="flex flex-col md:flex-row items-center gap-16">
              <div className="md:w-1/2 order-2 md:order-1">
                <div className="bg-white rounded-lg shadow-lg p-10 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 relative">
                  <div className="absolute top-0 left-0 w-16 h-16 border-t-4 border-l-4 border-amber-200 -mt-4 -ml-4"></div>
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">{content.founder.name}</h3>
                  <p className="text-xl text-amber-600 mb-6">{content.founder.title}</p>
                  <blockquote className="text-lg italic text-gray-700 border-l-4 border-amber-500 pl-6 py-2 mb-8 relative">
                    <div className="absolute -top-2 -left-2 text-5xl text-amber-200/50 ">"</div>
                    <div className="relative z-10">{content.founder.quote}</div>
                    <div className="absolute -bottom-4 -right-2 text-5xl text-amber-200/50 ">"</div>
                  </blockquote>
                  ...
                  <div className="absolute bottom-0 right-0 w-16 h-16 border-b-4 border-r-4 border-amber-200 -mb-4 -mr-4"></div>
                </div>
              </div>
        ...
        <section className="py-28 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-5xl font-bold text-gray-900 mb-16 text-center relative inline-block">
              Meet Our{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-amber-600">
                Co-Founder
              </span>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-1/2">
                <div className="bg-white rounded-lg shadow-lg p-10 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 relative">
                  <div className="absolute top-0 right-0 w-16 h-16 border-t-4 border-r-4 border-amber-200 -mt-4 -mr-4"></div>
                  <h3 className="text-3xl font-bold text-gray-900 mb-2">{content.cofounder.name}</h3>
                  <p className="text-xl text-amber-600 mb-6">{content.cofounder.title}</p>
                  <blockquote className="text-lg italic text-gray-700 border-l-4 border-amber-500 pl-6 py-2 mb-8 relative">
                    <div className="absolute -top-2 -left-2 text-5xl text-amber-200/50 ">"</div>
                  ...
                  <div className="absolute bottom-0 left-0 w-16 h-16 border-b-4 border-l-4 border-amber-200 -mb-4 -ml-4"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-gradient-to-r from-amber-50 to-amber-50 rounded-3xl my-16 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-amber-200/20 rounded-full blur-2xl"></div>
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-amber-200/20 rounded-full blur-2xl"></div>

          <div className="text-center mb-16 relative">
            <span className="absolute -top-10 left-1/2 transform -translate-x-1/2 text-8xl text-amber-100/40 font-poppins font-bold">
              Veterans
            </span>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-gradient-to-r from-amber-50 to-amber-50 rounded-3xl my-16 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-64 h-64 bg-amber-200/20 rounded-full blur-2xl"></div>
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-amber-200/20 rounded-full blur-2xl"></div>
