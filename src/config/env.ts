export const env = {
  ...
  TEST_PORTAL: process.env.NEXT_PUBLIC_TEST_PORTAL_URL || "http://tests.main.local:5174",
  ...
  COMMUNITY_PORTAL: process.env.NEXT_PUBLIC_COMMUNITY_PORTAL_URL || "https://community.99notes.org",
